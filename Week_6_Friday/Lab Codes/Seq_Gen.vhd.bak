...
-- and dff_set appropriately using port map statements.
	D(2) <= ((not Q(1)) and Q(2)) or ((not Q(2)) and Q(1) and Q(0));
	D(1) <= ((not Q(2)) and (not Q(1)) and Q(0)) or ((not Q(2)) and Q(1) and (not Q(0))) or (Q(2) and (not Q(1)) and (not Q(0)));
   --D(2) <= (Q(0) and (Q(2) xor Q(1))) and (not reset);
	--D(1) <= ((not Q(2)) and (Q(1) xor Q(0))) and (not reset);
	D(0) <= (Q(1) or ((not Q(2)) and (not Q(0))));
