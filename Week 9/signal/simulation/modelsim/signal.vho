...
-- Design Ports Information
-- on_switch	=>  Location: PIN_38,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- pragma translate_on
PORT MAP (
	dataa => \clock_1|clock_proc:count[6]~q\,
	datad => VCC,
	cin => \clock_1|Add0~11\,
...
-- Equation(s):
-- \clock_1|count~11_combout\ = (\clock_1|Add0~12_combout\ & !\clock_1|Equal0~10_combout\)
...
-- pragma translate_on
PORT MAP (
	dataa => \clock_1|clock_proc:count[11]~q\,
	datad => VCC,
	cin => \clock_1|Add0~21\,
...
-- pragma translate_on
PORT MAP (
	datab => \clock_1|clock_proc:count[12]~q\,
	datad => VCC,
	cin => \clock_1|Add0~23\,
...
-- pragma translate_on
PORT MAP (
	datab => \clock_1|clock_proc:count[13]~q\,
	datad => VCC,
	cin => \clock_1|Add0~25\,
...
-- pragma translate_on
PORT MAP (
	dataa => \clock_1|clock_proc:count[14]~q\,
	datad => VCC,
	cin => \clock_1|Add0~27\,
...
-- pragma translate_on
PORT MAP (
	dataa => \clock_1|clock_proc:count[16]~q\,
	datad => VCC,
	cin => \clock_1|Add0~31\,
...
-- pragma translate_on
PORT MAP (
	datab => \clock_1|clock_proc:count[19]~q\,
	datad => VCC,
	cin => \clock_1|Add0~37\,
...
-- pragma translate_on
PORT MAP (
	dataa => \clock_1|clock_proc:count[20]~q\,
	datad => VCC,
	cin => \clock_1|Add0~39\,
...
-- Equation(s):
-- \clock_1|count~1_combout\ = (\clock_1|Add0~44_combout\ & !\clock_1|Equal0~10_combout\)
...
-- pragma translate_on
PORT MAP (
	dataa => \clock_1|clock_proc:count[24]~q\,
	datad => VCC,
	cin => \clock_1|Add0~47\,
...
-- Equation(s):
-- \clock_1|Equal0~0_combout\ = (!\clock_1|Add0~0_combout\ & (!\clock_1|Add0~6_combout\ & (!\clock_1|Add0~4_combout\ & !\clock_1|Add0~2_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \clock_1|Add0~0_combout\,
	datab => \clock_1|Add0~6_combout\,
	datac => \clock_1|Add0~4_combout\,
	datad => \clock_1|Add0~2_combout\,
	combout => \clock_1|Equal0~0_combout\);

-- Location: LCCOMB_X39_Y34_N10
\clock_1|Equal0~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \clock_1|Equal0~1_combout\ = (!\clock_1|Add0~14_combout\ & (!\clock_1|Add0~10_combout\ & (!\clock_1|Add0~8_combout\ & \clock_1|Add0~12_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \clock_1|Add0~14_combout\,
	datab => \clock_1|Add0~10_combout\,
	datac => \clock_1|Add0~8_combout\,
...
-- Equation(s):
-- \clock_1|Equal0~2_combout\ = (!\clock_1|Add0~20_combout\ & (\clock_1|Add0~22_combout\ & (!\clock_1|Add0~18_combout\ & !\clock_1|Add0~16_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \clock_1|Add0~20_combout\,
	datab => \clock_1|Add0~22_combout\,
	datac => \clock_1|Add0~18_combout\,
	datad => \clock_1|Add0~16_combout\,
	combout => \clock_1|Equal0~2_combout\);

-- Location: LCCOMB_X37_Y34_N28
\clock_1|Equal0~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \clock_1|Equal0~3_combout\ = (!\clock_1|Add0~30_combout\ & (\clock_1|Add0~26_combout\ & (\clock_1|Add0~24_combout\ & \clock_1|Add0~28_combout\)))
...
-- Equation(s):
-- \clock_1|Equal0~4_combout\ = (\clock_1|Equal0~0_combout\ & (\clock_1|Equal0~1_combout\ & (\clock_1|Equal0~2_combout\ & \clock_1|Equal0~3_combout\)))
...
PORT MAP (
	...
	datac => \clock_1|Equal0~2_combout\,
...
-- Equation(s):
-- \clock_1|Equal0~5_combout\ = (\clock_1|Add0~32_combout\ & (\clock_1|Add0~38_combout\ & (!\clock_1|Add0~34_combout\ & \clock_1|Add0~36_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \clock_1|Add0~32_combout\,
	datab => \clock_1|Add0~38_combout\,
	datac => \clock_1|Add0~34_combout\,
	datad => \clock_1|Add0~36_combout\,
	combout => \clock_1|Equal0~5_combout\);

-- Location: LCCOMB_X37_Y34_N10
\clock_1|Equal0~6\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \clock_1|Equal0~6_combout\ = (\clock_1|Add0~40_combout\ & (\clock_1|Add0~42_combout\ & (\clock_1|Add0~44_combout\ & !\clock_1|Add0~46_combout\)))
...
-- Equation(s):
-- \clock_1|Equal0~8_combout\ = (!\clock_1|Add0~54_combout\ & (!\clock_1|Add0~50_combout\ & (!\clock_1|Add0~52_combout\ & \clock_1|Equal0~7_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \clock_1|Add0~54_combout\,
	datab => \clock_1|Add0~50_combout\,
	datac => \clock_1|Add0~52_combout\,
...
-- Equation(s):
-- \clock_1|Equal0~10_combout\ = (!\clock_1|Add0~60_combout\ & (!\clock_1|Add0~58_combout\ & (!\clock_1|Add0~62_combout\ & \clock_1|Equal0~9_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \clock_1|Add0~60_combout\,
	datab => \clock_1|Add0~58_combout\,
	datac => \clock_1|Add0~62_combout\,
...
-- Equation(s):
-- \Equal0~2_combout\ = (!\Add0~18_combout\ & (!\Add0~20_combout\ & (!\Add0~22_combout\ & !\Add0~24_combout\)))
...
-- Equation(s):
-- \Equal0~1_combout\ = (!\Add0~10_combout\ & (!\Add0~12_combout\ & (!\Add0~16_combout\ & !\Add0~14_combout\)))
...
-- Equation(s):
-- \Equal0~3_combout\ = (!\Add0~32_combout\ & (!\Add0~28_combout\ & (!\Add0~26_combout\ & !\Add0~30_combout\)))
...
-- Equation(s):
-- \Equal0~4_combout\ = (!\Add0~34_combout\ & (!\Add0~38_combout\ & (!\Add0~36_combout\ & !\Add0~40_combout\)))
...
-- Equation(s):
-- \Equal0~7_combout\ = (!\Add0~42_combout\ & (!\Add0~50_combout\ & (!\Add0~52_combout\ & \Equal0~6_combout\)))
...
-- Equation(s):
-- \Equal0~9_combout\ = (!\Add0~60_combout\ & (!\Add0~62_combout\ & (!\Add0~58_combout\ & \Equal0~8_combout\)))
...
-- Equation(s):
-- \count~2_combout\ = (\Add0~6_combout\ & (((!\Equal0~9_combout\) # (!\Equal4~0_combout\)) # (!\Equal3~2_combout\)))
...
-- Equation(s):
-- \Equal6~2_combout\ = (\Add0~4_combout\ & (\Add0~8_combout\ & \Add0~2_combout\))
...
-- Equation(s):
-- \Equal6~3_combout\ = (\Add0~0_combout\ & (!\Add0~6_combout\ & (\Equal6~2_combout\ & \Equal0~9_combout\)))
...
-- Equation(s):
-- \N~0_combout\ = (!\Equal0~11_combout\ & !\Equal6~3_combout\)
...
-- Equation(s):
-- \Equal1~0_combout\ = (!\Add0~6_combout\ & !\Add0~0_combout\)
...
-- Equation(s):
-- \Equal1~1_combout\ = (((!\Equal0~9_combout\) # (!\Equal0~0_combout\)) # (!\Add0~2_combout\)) # (!\Equal1~0_combout\)
...
-- Equation(s):
-- \Equal7~2_combout\ = (\Add0~8_combout\ & (!\Add0~4_combout\ & (\Equal3~2_combout\ & \Equal0~9_combout\)))
...
-- Equation(s):
-- \Equal4~1_combout\ = (\Equal0~10_combout\ & (!\Add0~2_combout\ & (\Equal4~0_combout\ & \Equal0~9_combout\)))
...
-- Equation(s):
-- \Equal2~0_combout\ = (!\Add0~8_combout\ & (!\Add0~4_combout\ & (\Add0~0_combout\ & \Add0~6_combout\)))
...
-- Equation(s):
-- \Equal5~0_combout\ = (((!\Equal0~9_combout\) # (!\Equal4~0_combout\)) # (!\Add0~2_combout\)) # (!\Equal1~0_combout\)
...
-- Equation(s):
-- \N[1]~3_combout\ = ((\N[1]~1_combout\ & ((\Equal6~3_combout\) # (\Equal7~2_combout\)))) # (!\Equal1~1_combout\)
...
-- Equation(s):
-- \N[1]~4_combout\ = (\N[1]~3_combout\) # ((\Equal1~1_combout\ & ((\reset~input_o\) # (\Equal0~11_combout\))))
...
-- Equation(s):
-- \N~2_combout\ = (\Equal6~3_combout\) # ((\Equal0~11_combout\) # (!\Equal1~1_combout\))
...
-- Equation(s):
-- \E~3_combout\ = (!\Equal0~11_combout\ & (((!\Equal2~0_combout\) # (!\Add0~2_combout\)) # (!\Equal0~9_combout\)))
...
-- Equation(s):
-- \W[0]~0_combout\ = (\Equal3~3_combout\ & (\Equal1~1_combout\ & (!\Equal0~11_combout\ & !\Equal2~1_combout\)))
...
-- Equation(s):
-- \S[0]~3_combout\ = (\reset~input_o\) # ((\Equal1~1_combout\ & (!\Equal0~11_combout\ & !\N[1]~1_combout\)))
...
-- Equation(s):
-- \W~1_combout\ = ((!\Equal4~1_combout\ & !\Equal6~3_combout\)) # (!\W[0]~0_combout\)
...
-- Equation(s):
-- \W[0]~2_combout\ = ((\Equal4~1_combout\) # ((\Equal7~2_combout\) # (\Equal6~3_combout\))) # (!\Equal5~0_combout\)
...
-- Equation(s):
-- \W[0]~3_combout\ = (\reset~input_o\) # ((\W[0]~0_combout\ & \W[0]~2_combout\))
