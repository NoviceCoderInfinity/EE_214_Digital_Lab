...
SIGNAL \add_instance|a13|Y~0_combout\ : std_logic;
SIGNAL \add_instance|a13|Y~1_combout\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	i => \add_instance|a13|Y~1_combout\,
	devoe => ww_devoe,
...
\add_instance|a13|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|a13|Y~0_combout\ = (\input_vector[4]~input_o\ & ((\input_vector[2]~input_o\ & (\input_vector[3]~input_o\)) # (!\input_vector[2]~input_o\ & (!\input_vector[3]~input_o\ & !\input_vector[1]~input_o\)))) # (!\input_vector[4]~input_o\ & 
...
PORT MAP (
	...
	combout => \add_instance|a13|Y~0_combout\);

-- Location: LCCOMB_X6_Y2_N10
\add_instance|a13|Y~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|a13|Y~1_combout\ = (\input_vector[0]~input_o\ & ((\add_instance|a13|Y~0_combout\) # ((\input_vector[1]~input_o\ & !\input_vector[3]~input_o\)))) # (!\input_vector[0]~input_o\ & (\input_vector[1]~input_o\ & (!\input_vector[3]~input_o\ & 
-- \add_instance|a13|Y~0_combout\)))
...
PORT MAP (
	...
	datad => \add_instance|a13|Y~0_combout\,
	combout => \add_instance|a13|Y~1_combout\);
