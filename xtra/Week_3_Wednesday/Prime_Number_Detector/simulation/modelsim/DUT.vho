...
-- Design Ports Information
-- output_vector[0]	=>  Location: PIN_59,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[0]	=>  Location: PIN_55,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[2]	=>  Location: PIN_58,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[4]	=>  Location: PIN_56,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[3]	=>  Location: PIN_60,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[1]	=>  Location: PIN_57,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \add_instance|OR2|Y~0_combout\ = (\input_vector[4]~input_o\ & ((\input_vector[2]~input_o\ & ((\input_vector[3]~input_o\))) # (!\input_vector[2]~input_o\ & (!\input_vector[1]~input_o\ & !\input_vector[3]~input_o\)))) # (!\input_vector[4]~input_o\ & 
-- (\input_vector[2]~input_o\ $ ((\input_vector[1]~input_o\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1001110000010110",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \add_instance|OR2|Y~1_combout\ = (\input_vector[0]~input_o\ & ((\add_instance|OR2|Y~0_combout\) # ((!\input_vector[3]~input_o\ & \input_vector[1]~input_o\)))) # (!\input_vector[0]~input_o\ & (!\input_vector[3]~input_o\ & (\input_vector[1]~input_o\ & 
-- \add_instance|OR2|Y~0_combout\)))
