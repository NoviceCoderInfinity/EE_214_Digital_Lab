...
\add_instance|o6|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|o6|Y~0_combout\ = (!\input_vector[8]~input_o\ & !\input_vector[4]~input_o\)
...
PORT MAP (
	...
	combout => \add_instance|o6|Y~0_combout\);
...
\add_instance|o6|Y~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|o6|Y~1_combout\ = (\input_vector[0]~input_o\ & ((\input_vector[2]~input_o\) # ((\input_vector[6]~input_o\) # (!\add_instance|o6|Y~0_combout\))))
...
PORT MAP (
	...
	datab => \add_instance|o6|Y~0_combout\,
	datac => \input_vector[6]~input_o\,
	datad => \input_vector[0]~input_o\,
	combout => \add_instance|o6|Y~1_combout\);
...
\add_instance|o5|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|o5|Y~0_combout\ = (\input_vector[0]~input_o\ & ((\input_vector[7]~input_o\) # ((\input_vector[3]~input_o\) # (!\add_instance|o6|Y~0_combout\))))
...
PORT MAP (
	...
	datad => \input_vector[0]~input_o\,
	combout => \add_instance|o5|Y~0_combout\);
...
\add_instance|o4|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|o4|Y~0_combout\ = (\input_vector[7]~input_o\) # ((\input_vector[6]~input_o\) # ((\input_vector[8]~input_o\) # (\input_vector[5]~input_o\)))
...
\add_instance|o4|Y~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|o4|Y~1_combout\ = (\add_instance|o4|Y~0_combout\ & \input_vector[0]~input_o\)
...
-- pragma translate_on
PORT MAP (
	dataa => \add_instance|o4|Y~0_combout\,
	datad => \input_vector[0]~input_o\,
	combout => \add_instance|o4|Y~1_combout\);
