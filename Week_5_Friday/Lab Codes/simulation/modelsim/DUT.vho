...
-- state_out[0]	=>  Location: PIN_58,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \dut_instance|add_instance|equ~0_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|equ~1_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|equ~2_combout\ : std_logic;
...
-- Equation(s):
-- \shift_reg~3_combout\ = (\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\ & (!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_udr~0_combout\ & \io~q\))
...
\dut_instance|add_instance|equ~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|equ~0_combout\ = (dut_input(2) & (dut_input(6) & (dut_input(5) $ (!dut_input(1))))) # (!dut_input(2) & (!dut_input(6) & (dut_input(5) $ (!dut_input(1)))))
...
PORT MAP (
	...
	datac => dut_input(5),
	datad => dut_input(1),
	combout => \dut_instance|add_instance|equ~0_combout\);
...
\dut_instance|add_instance|equ~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|equ~1_combout\ = (dut_input(3) & (dut_input(7) & (dut_input(0) $ (!dut_input(4)))))
...
PORT MAP (
	...
	datac => dut_input(4),
	datad => dut_input(7),
	combout => \dut_instance|add_instance|equ~1_combout\);

-- Location: LCCOMB_X30_Y25_N20
\dut_instance|add_instance|equ~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|equ~2_combout\ = (\dut_instance|add_instance|equ~0_combout\ & \dut_instance|add_instance|equ~1_combout\)
...
-- pragma translate_on
PORT MAP (
	datac => \dut_instance|add_instance|equ~0_combout\,
	datad => \dut_instance|add_instance|equ~1_combout\,
	combout => \dut_instance|add_instance|equ~2_combout\);

-- Location: LCCOMB_X29_Y25_N20
\datau[3]~18\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[3]~18_combout\ = (\shift_reg~0_combout\ & (dut_input(3) & (\dut_instance|add_instance|equ~2_combout\ $ (!dut_input(7)))))
...
PORT MAP (
	...
	datab => dut_input(3),
	datac => \dut_instance|add_instance|equ~2_combout\,
	datad => dut_input(7),
...
-- Equation(s):
-- \datau[0]~1_combout\ = (dut_input(3) & (((!dut_input(7)) # (!\dut_instance|add_instance|equ~0_combout\)) # (!\dut_instance|add_instance|equ~1_combout\))) # (!dut_input(3) & (((dut_input(7)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|add_instance|equ~1_combout\,
	datab => \dut_instance|add_instance|equ~0_combout\,
	datac => dut_input(3),
	datad => dut_input(7),
...
-- Equation(s):
-- \dut_instance|add_instance|LessThan1~0_combout\ = (dut_input(3) & (((dut_input(2) & !dut_input(6))) # (!dut_input(7)))) # (!dut_input(3) & (dut_input(2) & (!dut_input(6) & !dut_input(7))))
...
-- Equation(s):
-- \dut_instance|add_instance|LessThan1~2_combout\ = (dut_input(2) & (dut_input(6) & (dut_input(7) $ (!dut_input(3))))) # (!dut_input(2) & (!dut_input(6) & (dut_input(7) $ (!dut_input(3)))))
...
-- Equation(s):
-- \dut_instance|add_instance|LessThan1~1_combout\ = (dut_input(1) & (((dut_input(0) & !dut_input(4))) # (!dut_input(5)))) # (!dut_input(1) & (dut_input(0) & (!dut_input(4) & !dut_input(5))))
...
-- Equation(s):
-- \datau[2]~14_combout\ = (dut_input(2) & ((\dut_instance|add_instance|LessThan1~0_combout\) # ((\dut_instance|add_instance|LessThan1~2_combout\ & \dut_instance|add_instance|LessThan1~1_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|add_instance|LessThan1~0_combout\,
	datab => \dut_instance|add_instance|LessThan1~2_combout\,
	datac => dut_input(2),
	datad => \dut_instance|add_instance|LessThan1~1_combout\,
	combout => \datau[2]~14_combout\);

-- Location: LCCOMB_X30_Y25_N4
\datau[0]~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[0]~2_combout\ = (dut_input(6) & (((!dut_input(1) & dut_input(5))) # (!dut_input(2)))) # (!dut_input(6) & (!dut_input(1) & (!dut_input(2) & dut_input(5))))
...
-- Equation(s):
-- \datau[0]~3_combout\ = (\datau[0]~2_combout\) # ((dut_input(4) & (\dut_instance|add_instance|equ~0_combout\ & !dut_input(0))))
...
-- Equation(s):
-- \datau[0]~4_combout\ = (\dut_instance|add_instance|equ~2_combout\ & (((dut_input(7)) # (!dut_input(3))))) # (!\dut_instance|add_instance|equ~2_combout\ & (!dut_input(3) & ((\datau[0]~3_combout\) # (dut_input(7)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|add_instance|equ~2_combout\,
...
-- Equation(s):
-- \datau[2]~15_combout\ = (\datau[0]~1_combout\ & (((\datau[0]~4_combout\)))) # (!\datau[0]~1_combout\ & ((\datau[0]~4_combout\ & ((dut_input(6)))) # (!\datau[0]~4_combout\ & (\datau[2]~14_combout\))))
...
-- Equation(s):
-- \datau[1]~10_combout\ = (dut_input(1) & ((\dut_instance|add_instance|LessThan1~0_combout\) # ((\dut_instance|add_instance|LessThan1~2_combout\ & \dut_instance|add_instance|LessThan1~1_combout\))))
...
-- Equation(s):
-- \datau[1]~12_combout\ = (\datau[1]~11_combout\ & (((dut_input(5) & dut_input(1))) # (!\datau[0]~6_combout\))) # (!\datau[1]~11_combout\ & (\datau[0]~6_combout\ & (!dut_input(5))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1010011000100110",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \datau[1]~11_combout\,
	datab => \datau[0]~6_combout\,
	datac => dut_input(5),
	datad => dut_input(1),
...
-- Equation(s):
-- \datau[0]~0_combout\ = (dut_input(0) & ((\dut_instance|add_instance|LessThan1~0_combout\) # ((\dut_instance|add_instance|LessThan1~1_combout\ & \dut_instance|add_instance|LessThan1~2_combout\))))
...
PORT MAP (
	dataa => dut_input(0),
	datab => \dut_instance|add_instance|LessThan1~1_combout\,
	datac => \dut_instance|add_instance|LessThan1~2_combout\,
