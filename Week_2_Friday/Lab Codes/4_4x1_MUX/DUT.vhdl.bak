...
architecture DutWrap of DUT is
	...
	Component f_b_4x1_MUX is
		port (d3, d2, d1, d0, c3, c2, c1, c0, b3, b2, b1, b0, a3, a2, a1, a0, sel1, sel0: in std_logic ;
		   Y3, Y2, Y1, Y0: out std_logic);
	end component f_b_4x1_MUX;
begin

   -- input/output vector element ordering is critical,
   -- and must match the ordering in the trace file!
   add_instance: f_b_4x1_MUX port map (
													d3 => input_vector(17), d2 => input_vector(16), d1 => input_vector(15), d0 => input_vector(14), 
